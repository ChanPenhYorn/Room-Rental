...
--
-- Class AppNotification as table app_notification
--
...
--
-- Class BecomeOwnerRequest as table become_owner_request
--
...
-- Indexes
CREATE UNIQUE INDEX "contract_booking_idx" ON "contract" USING btree ("bookingId");
...
--
-- Class Favorite as table favorite
--
CREATE TABLE "favorite" (
    ...
    "roomId" bigint NOT NULL,
    "createdAt" timestamp without time zone NOT NULL,
    "_roomFavoritesRoomId" bigint,
    "_userFavoritesUserId" bigint
);

-- Indexes
CREATE UNIQUE INDEX "favorite_user_room_unique_idx" ON "favorite" USING btree ("userId", "roomId");
...
CREATE TABLE "review" (
    ...
    "createdAt" timestamp without time zone NOT NULL,
    "_roomReviewsRoomId" bigint,
    "_userReviewsUserId" bigint
);
...
CREATE TABLE "room" (
    ...
    "pendingData" text,
    "hasPendingEdit" boolean NOT NULL DEFAULT false
);

--
-- Class RoomFacility as table room_facility
--
...
-- Indexes
CREATE UNIQUE INDEX "user_user_info_idx" ON "user" USING btree ("userInfoId");
...
--
-- Foreign relations for "app_notification" table
--
...
--
-- Foreign relations for "become_owner_request" table
--
...
--
-- Foreign relations for "bill" table
--
...
--
-- Foreign relations for "contract" table
--
ALTER TABLE ONLY "contract"
    ADD CONSTRAINT "contract_fk_0"
...
--
-- Foreign relations for "favorite" table
--
...
--
-- Foreign relations for "room" table
--
...
--
-- Foreign relations for "room_facility" table
--
ALTER TABLE ONLY "room_facility"
    ADD CONSTRAINT "room_facility_fk_0"
    FOREIGN KEY("roomId")
    REFERENCES "room"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
ALTER TABLE ONLY "room_facility"
    ADD CONSTRAINT "room_facility_fk_1"
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('dwellly', '20260305141329018', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260305141329018', "timestamp" = now();
