...
import 'package:dwellly_server/src/generated/become_owner_request.dart' as _i8;
import 'package:dwellly_server/src/generated/owner_request_status.dart' as _i9;
import 'package:dwellly_server/src/generated/payment_request.dart' as _i10;
import 'package:dwellly_server/src/generated/room.dart' as _i11;
import 'package:dwellly_server/src/generated/room_type.dart' as _i12;
import 'package:dwellly_server/src/generated/room_status.dart' as _i13;
import 'package:dwellly_server/src/generated/user_role.dart' as _i14;
import 'package:dwellly_server/src/generated/greetings/greeting.dart' as _i15;
...
class _OwnerRequestEndpoint {
  ...
  _i3.Future<_i8.BecomeOwnerRequest?> submitRequest(
    _i1.TestSessionBuilder sessionBuilder, {
    String? message,
  }) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i8.BecomeOwnerRequest?>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i8.BecomeOwnerRequest>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i10.PaymentRequest?>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
...
class _RoomEndpoint {
  ...
  _i3.Future<_i11.Room?> getRoomById(
    _i1.TestSessionBuilder sessionBuilder,
    int id,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
  ...
  _i3.Future<List<_i11.Room>> searchRooms(
    _i1.TestSessionBuilder sessionBuilder,
    String query,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
  ...
  _i3.Future<_i11.Room?> createRoom(
    _i1.TestSessionBuilder sessionBuilder,
    _i11.Room room,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
