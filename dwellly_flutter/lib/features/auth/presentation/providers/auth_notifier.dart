  ...
  Future<void> updateProfile({
    ...
    try {
      ...
      if (existingUser != null) {
        ...
        if (updated != null) {
          // Explicitly update state if repository returned a user with userInfo
          if (updated.userInfo != null) {
            state = AuthState.authenticated(updated.userInfo!);
          } else {
            // Fallback to previous state but out of loading
